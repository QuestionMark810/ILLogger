...
internal class UIInfoMessage : UIState, IHaveBackButtonCommand
{
	...
	private UITextPanel<LocalizedText> _back;
	private UITextPanel<LocalizedText> _logs;
	...
	public override void OnInitialize()
	{
        ...
        _infoPanel = new(Language.GetTextValue("Errors may have resulted from conflicts with other mods, Terraria, or tModLoader updates."))
        { VAlign = 1 };
        ...
        _back = new UITextPanel<LocalizedText>(Language.GetText("tModLoader.Exit"), 0.7f, large: true)
        { VAlign = 0.75f, };
        ...
        _logs = new UITextPanel<LocalizedText>(Language.GetText("Workshop.ReportLogsButton"), 0.7f, large: true)
        { VAlign = 0.75f };
	...
	internal void ShowMessage(Mod mod)
	{
		if (!Program.IsMainThread)
		{
			Main.QueueMainThreadAction(() => ShowMessage(mod));
			return;
		}
